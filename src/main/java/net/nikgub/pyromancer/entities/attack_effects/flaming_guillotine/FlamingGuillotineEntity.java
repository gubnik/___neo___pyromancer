package net.nikgub.pyromancer.entities.attack_effects.flaming_guillotine;
...
import net.nikgub.pyromancer.registries.vanila.DamageSourceRegistry;
...
import net.nikgub.pyromancer.util.EntityUtils;
