...
public class SoundEventRegistry
{
    ...
    public static final RegistryObject<SoundEvent> MUSKET_SHOT = SOUNDS.register("musket_shot",
        () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(PyromancerMod.MOD_ID, "musket_shot")));
    public static final RegistryObject<SoundEvent> MUSKET_LOAD = SOUNDS.register("musket_load",
        () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(PyromancerMod.MOD_ID, "musket_load")));
}
